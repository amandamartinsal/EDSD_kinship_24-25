...
subtitle: "European Doctoral School of Demography, Paris, November 18-21, 2024"
...
- Download the syllabus: https://github.com/amandamartinsal/EDSD_kinship/blob/master/EDSD_2024_syllabus.pdf [UPDATE]
- The course's slides are available here: https://github.com/amandamartinsal/EDSD_kinship/tree/master/slides [UPDATE]
- Find this website's source code on GitHub: https://github.com/amandamartinsal/EDSD_kinship [UPDATE]
...
We can access demographic rates from any country in the world, produced by the World Population Prospects (WPP) project. We will download fertility, mortality and population data for all countries from 1950 to 2023.
...
In the lab sessions we will work with Brazil, so lets see the case of Brazil female population in 2015:
...
> For time-variant model, you will need population data for the argument "n". Please download the data [here](https://population.un.org/wpp/Download/Files/1_Indicators%20(Standard)/CSV_FILES/WPP2022_Population1JanuaryBySingleAgeSex_Medium_1950-2021.zip).
...
wpp_pop <- function(country_name) {
  WPP2022_pop <- read_csv("unwppdata/WPP2022_Population1JanuaryBySingleAgeSex_Medium_1950-2021.csv")
...
Assignments (one per group) should be sent by email to martins@demogr.mpg.de **before midnight of Friday, May 24.** 
